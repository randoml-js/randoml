...
var RandoML = function RandoML(_ref) {
  var _min = _ref.min,
      _max = _ref.max,
      _exclude = _ref.exclude,
      held = _ref.held;
  ...
  _defineProperty(this, "randomize", function (min, max, exclude) {
    var randomNumber = Math.floor(Math.random() * (max - min)) + min;
    exclude.map(function (item) {
      return item !== randomNumber;
    });
    randomNumber !== exclude ? randomNumber : randomNumber + 1;
  });

  _defineProperty(this, "neural", function () {});

  this.randomize(_min, _max, _exclude);
